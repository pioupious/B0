...
_Linux est un système d'exploitation libre depuis 1991, fondé sur une philosophie de collaboration et d'ouverture, utilisé dans divers environnements._

## Histoire

* Richard Stallman a initié le mouvement du logiciel libre dans les années 1980 après une expérience avec une imprimante propriétaire.
  
  * Liberté d'utiliser le logiciel pour tout usage.
  * Liberté d'étudier le code source et de le modifier. ​
  * Liberté de redistribuer des copies.
  * Liberté d'améliorer le programme et de partager ces améliorations. ​
    
* Le projet GNU a été lancé en 1983 pour créer un système d'exploitation libre, mais manquait d'un noyau. ​
* Linus Torvalds a développé le noyau Linux en 1991, qui a été intégré au projet GNU, formant GNU/Linux en 1992. ​
* L'adoption de Linux a explosé dans les années 1990-2000, devenant essentiel pour les serveurs et les supercalculateurs. ​

## Philosophie de Linux

Basée sur cinq principes : 
  * liberté
  * communauté
  * simplicité
  * sécurité
...
Licence GPL garantit l'utilisation, la modification et la redistribution du code.

La communauté de développeurs assure une évolution continue et une robustesse du système. ​

## Conclusion 

Linux est plus qu’un simple OS : c’est un mouvement technologique et philosophique qui prône la liberté
numérique. Il est aujourd’hui incontournable, des serveurs aux supercalculateurs, en passant par les
smartphones et l’IoT.
